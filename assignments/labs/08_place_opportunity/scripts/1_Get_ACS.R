...
B01001 <- B01001 |> 
  mutate(across(under18:P_Female, ~na_if(.x, NaN)))
...
B02001 <- B02001 |> 
  mutate(
    PWhite = B02001_002E / B02001_001E,
    PBlack = B02001_003E / B02001_001E,
    PAIAN = B02001_004E / B02001_001E,
    PAsian = B02001_005E / B02001_001E,
    PNonwhite = (B02001_001E - B02001_002E) / B02001_001E
  )

B02001 <- B02001 |> 
  mutate(across(PWhite:PNonwhite, ~na_if(.x, NaN)))

B02001<-B02001 |> 
  select(GEOID, PWhite, PBlack, PAIAN, PAsian, PNonwhite)
