...
-   **Office Hours and Availability:** I am available to speak one on one - you can book an appointment via my [Calendly page]({{< var instructor.calendly_url >}}):

    Of course, I am happy to chat either before or after class if I am available.
...
UP 570: Neighborhood Analysis is open to students with graduate-level standing. The course assumes that you have previously taken [UP 517: Data Science for Planners](https://courses.illinois.edu/schedule/terms/UP/517) or have substantial experience with data manupulation in R, particularly using approaches linked to the [Tidyverse](https://www.tidyverse.org). Our first few course sessions will focus on ensuring that we are all familiar with some of the basic workflows and methods which we'll make use of over the course of the semester.
