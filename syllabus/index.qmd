...
Welcome to Neighborhood Analysis! I am excited to teach and learn with you this semester.
...
-   **One-on-one meetings:** I am available to speak one on one - you can book an appointment via my [Calendly page](%7B%7B%3C%20var%20instructor.calendly_url%20%3E%7D%7D). Of course, I am happy to chat before or after class if I am available.

```{=html}
<!-- Calendly inline widget begin -->
<div class="calendly-inline-widget" data-url="https://calendly.com/agreen4/office-hours" style="min-width:320px;height:700px;"></div>
<script type="text/javascript" src="https://assets.calendly.com/assets/external/widget.js" async></script>
<!-- Calendly inline widget end -->
```
-   **Troubleshooting:** Plan on using our class [Github Discussion Forum](%7B%7B%3C%20var%20course.discuss%20%3E%7D%7D), email, and office hours to get help with troubleshooting problems as they arise in your work. The [Resources](/resources) page provides thoughts and resources for troubleshooting. I also encourage you to work with others in the class to troubleshoot problems - it is highly likely that others in the class have encountered similar problems, and this allows us to build a repository of our problems and responses.
...
UP 570: Neighborhood Analysis is open to students with graduate-level standing. The course assumes that you have previously taken [UP 517: Data Science for Planners](https://courses.illinois.edu/schedule/terms/UP/517) or have substantial experience with data manipulation in R, particularly using approaches linked to the [Tidyverse](https://www.tidyverse.org). Our first few course sessions will focus on ensuring that we are all familiar with basic workflows and methods which we'll make use of over the course of the semester.
...
2.  Assume any facts or figures rendered via AI models are incorrect.
3.  Use these tools to help you break through coding or analysis challenges, not for writing up your narrative or findings.
4.  While you do not need to provide a citation for Chat GPT or other AI tools in your narrative or references, please indicate in any methods statements that these tools were employed. Please also reflect upon your application of these tools in your assignment submission reflections.

A few related expectations:

1.  Let's keep a running dialog about how you're employing these tools, what some of the challenges are, and how you may want to integrate such technology into your workflows.

2.  You are ultimately responsible for all content represented in your work. As part of the class pedagogy, you will electronically publish your assignments - this means you are publicly responsible for the content you produce.

3.  All writing should be your own and written by you and not generative AI (unless you are quoting or citing someone else).

4.  Deviations from these expectations will be treated as academic dishonesty and are subject to review and disposition based upon the University's honor code.
